...
function Sidebar({ collapsed, onToggleCollapse }) {
  ...
  return (
    <div className="flex h-screen">
      ...
      {/* Collapsible Button - Always visible outside sidebar */}
      <div className="flex items-start pt-6 -ml-3">
        <button
          onClick={onToggleCollapse}
          className="w-8 h-8 rounded-full hover:bg-gray-100 transition-colors bg-white border border-gray-200 shadow-sm flex items-center justify-center"
        >
